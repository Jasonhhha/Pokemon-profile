...
export const regions: Record<RegionId, { name: string; english: string; subtitle: string; number: string; dialogue: string[]; spots: Spot[] }> = {
  ...
  verity: { name: '心齐湖', english: 'LAKE VERITY', subtitle: '风与湖水的约定 · 研究项目', number: '02', dialogue: ['湖畔研究站记录着你的量化研究与机器学习项目。', '从西侧出口回到双叶镇，向东还能继续前往天冠山。', '波加曼和泳圈鼬正在湖边等你发现新的线索。'], spots: [{ id: 'projects', x: 22, y: 14 }, { id: 'piplup', x: 15, y: 13 }, { id: 'buizel', x: 20, y: 14 }, { id: 'drifloon', x: 5, y: 9 }, { id: 'starly', x: 22, y: 8 }] },
